            ...
            <div class="container">
                ...
                <c:choose>
                	<c:when test="${isLogOn==true and not empty vo}">
                		<a class="btn btn-primary btn-xl text-uppercase" href="${pageContext.request.contextPath}/userlogout">로그아웃</a>
                	</c:when>
                	<c:otherwise>
		                <a class="btn btn-primary btn-xl text-uppercase" href="javascript:void(0)"  onclick="kakaoLogin();">카카오 로그인</a>
                	</c:otherwise>
                </c:choose>
            </div>
        </header>
