...
<table border="1" style="width:1000px; text-align:center" >
	...
	<tr>
		...
		<th><input type="text" id="subject" name="subject" value="${vo.notice_subject}" style="width:900px; text-align:center"/></th>
	</tr>
	<tr>
		<td>작성자</td>
	...
	<tr>
		...
		<td><textarea id="content" name="content" style="height:400px; width:900px; text-align:center">${vo.notice_content}</textarea></td>
	</tr>
</table>
<input type="hidden" id="code" name="code" value="${vo.notice_code }">
